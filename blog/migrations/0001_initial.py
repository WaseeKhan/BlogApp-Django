    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_image', models.ImageField(blank=True, default='blog/images/default_post_image.webp', help_text='Upload a featured image for this post (recommended size: 1200x630px),', null=True, upload_to='blog/images/%Y/%m/%d/')),
